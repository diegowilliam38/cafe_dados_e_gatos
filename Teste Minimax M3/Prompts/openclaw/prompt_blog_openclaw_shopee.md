# PROMPT CLINE — CRIAR BLOG DE PRODUTOS SHOPEE COM OPENCLAW

Crie um blog moderno de produtos da Shopee usando os arquivos já gerados pela curadoria OpenClaw e pelo agente de conteúdo.
...
```text
~/Documents/shopee/openclaw/blog_openclaw/
```
