...
- nao criar pasta paralela como `blog_hermes/`
- nao espalhar arquivos do site fora de `site_hermes/`
- preservar os arquivos que ja existirem em `site_hermes/`, especialmente `hero.png` e `data/`
...
Se ja existir `site_hermes/hero.png`, usar esse arquivo.
...
- erros encontrados
- decisoes tomadas
- confirmacao de que nada foi criado fora de `site_hermes/`
